...
#include <ArduinoJson.h> // Usado para parsear JSON recebido do frontend
...
DNSServer dnsServer;               // Servidor DNS para redirecionar qualquer domínio ao ESP32 no modoAP
  // Problema DNS: mais funcional para IOS e LINUX
